export const featuredProjects = [
  {
    id: 1,
    name: "Action For Collective Change Initiative",
    image: "/projects/acci.png",
    description:
      "Action For Collective Change Initiative (ACCI) is a nonprofit organization dedicated to creating positive social and environmental change across Africa, with operations in Liberia, Rwanda, Sierra Leone, and Ghana.",
    tags: ["Next js", "TypeScript", "Tailwind CSS", "Mongo DB"],
    demoUrl: "https://weareacci.org/",
    repoUrl: "#",
  },
  {
    id: 2,
